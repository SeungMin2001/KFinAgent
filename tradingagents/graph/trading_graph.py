...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        self.graph_setup = GraphSetup(
            ...
            preload_verified_snapshot=(
                self.config.get("data_vendors", {}).get("core_stock_apis") == "kis"
            ),
    ...
    def resolve_instrument_context(self, ticker: str, asset_type: str = "stock") -> str:
        ...
        """
        # Korean KIS-only deployments intentionally avoid a second data vendor.
        # KIS quotation endpoints do not expose company-profile metadata, so a
        # ticker-only context is more honest than silently calling yfinance.
        provider = self.config.get("instrument_identity_provider", "yfinance")
        identity = {} if provider == "none" else resolve_instrument_identity(ticker)
    ...
    def _run_signature(self, asset_type: str) -> str:
        ...
        return "|".join([
            ...
            f"korean_evidence_agents={bool(self.config.get('enable_korean_evidence_agents', False))}",
