...
_ENV_OVERRIDES = {
    ...
    "TRADINGAGENTS_KOREAN_MARKET_LOOKBACK_DAYS": "korean_market_lookback_days",
    "TRADINGAGENTS_KOREAN_SNAPSHOT_INDICATORS": "korean_snapshot_indicators",
    "TRADINGAGENTS_KOREAN_DISCLOSURE_LOOKBACK_DAYS": "korean_disclosure_lookback_days",
    "TRADINGAGENTS_KOREAN_DISCLOSURE_LIMIT": "korean_disclosure_limit",
    "TRADINGAGENTS_KOREAN_DISCLOSURE_CHUNK_CHARS": "korean_disclosure_chunk_chars",
    "TRADINGAGENTS_KOREAN_US_MACRO_LOOKBACK_DAYS": "korean_us_macro_lookback_days",
...
DEFAULT_CONFIG = _apply_env_overrides({
    ...
    "data_vendors": {
        "core_stock_apis": "yfinance",       # Options: kis, alpha_vantage, yfinance
        "technical_indicators": "yfinance",  # Options: kis, alpha_vantage, yfinance
    ...
    "benchmark_map": {
        ...
        ".KS":  "^KS11",       # Korea Exchange KOSPI (Yahoo convention)
        ".KQ":  "^KQ11",       # Korea Exchange KOSDAQ (Yahoo convention)
